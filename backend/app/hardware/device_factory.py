...
import logging
from app.hardware.device_base import BaseDevice
...
class DeviceFactory:
    ...
    def load_device_plugins(cls):
        ...
        try:
            ...
            from app.hardware.devices.temperature_sensor import TemperatureSensor
            from app.hardware.devices.outlet import Outlet
